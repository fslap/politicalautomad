...
/**
 * Party component Donate Block (politicalpartysite → Automad Party block).
 *
...
class DonateBlock extends AbstractDynamicTemplateBlock {
	...
	public function context(array $config): array {
		return [
			'title' => $config['title'] ?? 'Support Our Movement',
			'amounts' => $config['amounts'] ?? [10, 25, 50, 100],
			'message' => $config['message'] ?? 'Every contribution strengthens our voice.',
		];
	}
}
