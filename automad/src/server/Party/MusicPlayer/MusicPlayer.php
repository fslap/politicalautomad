...
/**
 * Party component Music Player (politicalpartysite → Automad Party block).
 *
...
class MusicPlayer extends AbstractDynamicTemplateBlock {
	...
	public function context(array $config): array
	{
        ...
        return [
            ...
            'player_width' => $config['player_width'] ?? '100%',
            'player_height' => $config['player_height'] ?? '352',
            'iframe_border_radius' => $config['iframe_border_radius'] ?? '12px',
