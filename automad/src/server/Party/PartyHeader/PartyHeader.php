...
/**
 * Represents a quick statement on the political party side
 *
 ...
 *
 */
class PartyHeader extends AbstractMultiBlock {
    public __construct() {
    ...
    {
        $party_name_parts = explode(' ', $config['party_name'] ?? '');
        
        return [
            'warning_text' => $config['warning_text'] ?? '',
            'party_name_parts' => $party_name_parts,
